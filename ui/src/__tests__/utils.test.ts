...
import { getOptions, getFilter, mutiSearch } from '../utils/admin';
import type { Catelog } from '../types';

describe('admin utilities', () => {
  const mockCatelogs: Catelog[] = [
  ...
  describe('getOptions', () => {
    it('maps catelogs to select options', () => {
      const options = getOptions(mockCatelogs);
  ...
  describe('getFilter', () => {
    it('maps catelogs to filter options', () => {
      const filters = getFilter(mockCatelogs);
